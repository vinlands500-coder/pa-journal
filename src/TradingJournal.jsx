...
import { Plus, X, TrendingUp, TrendingDown, Image as ImageIcon, Brain, BarChart3, ChevronDown, ChevronUp, Trash2, Filter, Sparkles, AlertCircle, Cloud, CloudOff } from 'lucide-react';
...
function TradeCard({ trade, onDelete, onAnalyze, analyzing }) {
  const [open, setOpen] = useState(false);
  ...
  return (
    <div className="app" dir="rtl">
      ...
      <div className="trades-list">
        ...
        {filtered.map((t) => (
          <TradeCard key={t.id} trade={t} onDelete={remove} onAnalyze={handleAnalyze} analyzing={analyzingId === t.id} />
        ))}
      </div>
    </div>
  );
